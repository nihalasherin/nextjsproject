  ...
  const images = [
    {
      ...
      src: "img4.png",
      title: "DAMAC",
      description: "Bliss - Arabian Ranches III",
      location: "Bliss - Arabian Ranches III Dubai",
      price: "From AED 1,840,000",
    ...
    },
    {
      ...
      src: "image3.png",
      title: "EMAAR",
      description: "VIDA Residences @ Creek Beach",
      location: "Creek Beach, Dubai Creek Harbour Dubai",
      price: "From AED 1,718,888",
      tags: ["PENTHOUSE", "VILLAS"],
    },
    {
      icon: "/meras.svg",
      iconHeight: 16,
      ...
      src: "img4.png",
      title: "MERAAS",
      description: "CHIC Tower",
      location: "Business Bay Dubai",
      price: "From AED 1,460,000",
      tags: ["PENTHOUSE", "APARTMENTS"],
    },
    {
      icon: "/SobhaBrand.png",
      iconHeight: 16,
      ...
      src: "img.jpeg",
      title: "SOBHA",
      description: "One Park Avenue",
      location: "One Park Avenue - Sobha Hartland Dubai",
    ...
    },
    {
      ...
      src: "img.jpeg",
      title: "ELLINGTON",
      description: "Belgravia Square",
      location: "Jumeriah Village Circle Dubai",
      price: "From AED 969,828",
      tags: ["PENTHOUSE", "VILLAS"],
    },
    {
      icon: "/omniyat.png",
    ...
    },
    {
      ...
      src: "img.jpeg",
      title: "DAMAC",
      description: "June - Arabian Ranches III",
      location: "One Park Avenue - Sobha Hartland Dubai",
      price: "From AED 1,200,000",
      tags: ["PENTHOUSE", "VILLAS"],
    },
  ...
  return (
    <div>
      <div>
        ...
        >
          <div
            className="container MainHeading"
            style={{ width: "100%", maxWidth: "1200px", textAlign: "left" }}
          >
            <h1 className="first-sen">
              Once you engage with us, you won’t want to engage with anyone
              else.
            </h1>
            <div className="Main2ndHeading">
              <p className="second-sen">
                <span className="singleLine">
                  {" "}
                  Bliss - Arabian Ranches III,
                </span>
                <span className="secondSub singleLine"> Dubai, UAE</span>
              </p>
              <p
                className="hoverUnderline singleLine"
                style={{
                  fontSize: "1em",
                  cursor: "pointer",
                }}
              ...
              <ul className="nav nav-tabs mb-4">
                <li className="nav-item">
                  <a
                    ...
                    href="#"
                    style={{ color: "#00204a", fontSize: "20px" }}
                  >
            ...
            <div className="col-sm-4 col-md-6 col-lg-4">
              <div className="card-body">
                ...
                <p style={{ color: "#888", fontSize: "0.9rem" }}>
                  Bliss - Arabian Ranches III Dubai
                </p>
                <p
                  style={{
                    fontWeight: "bold",
        ...
        <div style={{ margin: "20px" }}>
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4918.927069363705!2d75.83119323341032!3d11.247724518260886!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba65bbe50ea0b7d%3A0xc4e01eaa6234847e!2sHiLITE%20Business%20Park%2C%20Poovangal%2C%20Pantheeramkavu%2C%20Kerala%20673014!5e0!3m2!1sen!2sin!4v1730732615745!5m2!1sen!2sin"
            width="100%"
            height="300"
          ...
          <div>
            <div>
              <button
                ...
                onClick={() => handleTagClick("VILLAS")}
                style={{
                  backgroundColor:
                    selectedTag === "VILLAS" ? "#0070f3" : "#f0f0f0",
                  color: selectedTag === "VILLAS" ? "#fff" : "#000",
                }}
              >
                Villa
              </button>
              <button
                ...
                style={{
                  backgroundColor:
                    selectedTag === "APARTMENTS" ? "#0070f3" : "#f0f0f0",
                  color: selectedTag === "APARTMENTS" ? "#fff" : "#000",
                }}
              >
                Apartments
              </button>
              <button
                className="eclipse-button"
                onClick={() => handleTagClick("PENTHOUSE")}
                style={{
                  backgroundColor:
                    selectedTag === "PENTHOUSE" ? "#0070f3" : "#f0f0f0",
                  color: selectedTag === "PENTHOUSE" ? "#fff" : "#000",
                }}
              >
                Penthouse
              </button>
              <button
                className="eclipse-button"
                onClick={() => handleTagClick("OFF PLAN")}
                style={{
                  backgroundColor:
                    selectedTag === "OFF PLAN" ? "#0070f3" : "#f0f0f0",
                  color: selectedTag === "OFF PLAN" ? "#fff" : "#000",
                }}
              >
                Off Plan
              </button>
        ...
        >
          ...
          >
            ...
            >
              "The customer journey has always been and will always be our
              priority."
            </p>
            <div
              style={{
